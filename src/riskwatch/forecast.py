...
DIRECT_ACTION_TERMS = ("привлеч", "зачислен", "зачислён", "направлен", "направ", "отправлен", "отправл", "призван", "призва", "заключил контракт", "заключен контракт", "заключён контракт", "начал службу")
